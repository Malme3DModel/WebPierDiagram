...
Private Sub ArcDataOpen(rstrFileName As String)
    ...
    For Each chform In Forms
        Select Case chform.Name
        Case Me.Name
        Case "frmPrint", "frmCalc" ' frmCalc.Name,
            Unload chform
        Case Else
'            If chform.Name = "frmRessha" Then
'                intPage = frmRessha.DispPage
...
'    End If
    ...
    ' --- ロードされていた子フォームを１つ開く
'    If bOpend = True Then
'        If chform_old.Name = frmCalc.Name Then
'            Call ShowCalcForm(False)
'        Else
'            chform_old.Show
'            If intPage <> -1 Then
...
Public Sub ChgCaption(rstrFileName As String)
    ...
    If Trim$(rstrFileName) = "" Then
        Caption = "橋脚図化システム 新規作成"
        gstrTitle = "新規作成"
    Else
        Caption = "橋脚図化システム " & Trim$(rstrFileName)
