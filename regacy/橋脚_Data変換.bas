...
'       .dat ‚Ì •ÏŠ·‚É g—p‚Å‚«‚é   •Ï”s
'
'             ?PROJECT?     Project_Titles = pEtc(0)
'             ?}–¼?"       }_‹´‹r_–¼Ìs(i)=pOutputName(i)
'             ?}”Ô?
'             ?kÚ?        }_‹´‹r_Scale(i) = pOutputSize(i)
'             ?Œ_–ñ”Ô†?    Project_Œ_–ñ”Ô†s = pEtc(1)
'
...
Option Explicit
      ...
      Public •\¦Form_}–Ê‰æ–Ês As String
      
      Public }_‹´‹r_–‡”i As Integer
      Public }_‹´‹r_‡”Ôi(10) As Integer   ' =0   }‚ğ ì} ‚µ‚È‚¢
      Public }_‹´‹r_–¼Ìs(10) As String   ' 1—À   2x³   3‹ë‘Ì   4Šî‘b   5Y   6Ş—¿•\
      Public }_‹´‹r_Scale(10) As Single
 
      
      Public }_‹´‹r_Auto•\¦s As String
      Public }_‹´‹r_•\¦–¼Ìs(10) As String
      ...
      Dim AllCount                As Integer
         ...
         Dim —À_I“_Loop‹Ø_Ty”i As Integer  ' —À_I“_Loop‹Ø_Type í—Ş”i
...
Sub ‹´‹rì}Às()
   ...
   ' ¢ŒëCK = 200: er ("¢ŒëCK = 200")
    ...
    '
    ¢er = "" ' 05/05/08
    If ¢er <> "" Then er (" ì}Às’†~‚µ‚Ü‚·"): If ¢ŒëCK > 99 Then Stop: Exit Sub Else Exit Sub
    '
    Call ‹´‹rData}İ’è
    '
    ...
    '[[[  Text Data ì¬ ]]]
    Print #31, "//‹´‹rData"
    For ii = 1 To YDi:     Print #31, Text_•ÏŠ·s(YData(ii)): Call ProAddOn: Next ii
    For ii = 1 To Šî‘bDi:   Print #31, Text_•ÏŠ·s(Šî‘bData(ii)): Call ProAddOn:  Next ii
    For ii = 1 To ’ŒDi:     Print #31, Text_•ÏŠ·s(’ŒData(ii)): Call ProAddOn:  Next ii
    For ii = 1 To StoperDi: Print #31, Text_•ÏŠ·s(StoperData(ii)): Call ProAddOn:  Next ii
    For ii = 1 To “¥ÀDi:   Print #31, Text_•ÏŠ·s(“¥ÀData(ii)): Call ProAddOn:  Next ii
    For ii = 1 To —ÀDi:     Print #31, Text_•ÏŠ·s(—ÀData(ii)): Call ProAddOn:  Next ii
    For ii = 1 To }İ’èDi: Print #31, Text_•ÏŠ·s(}İ’èData(ii)): Call ProAddOn:  Next ii
...
Call Read_Šù‘¶_‹´‹rData
     ...
     Case Else
            Šù‘¶_Datas = "*"
            Print #31, "//‹´‹rData"
            For ii = 1 To E_SDi:      Call SP_Šù‘¶_Data_Memo_Write(E_SData(ii)): Call ProAddOn: Next ii
            ...
            Case 1:
                        ...
                        For ii = 1 To E_YDi:     Call SP_Šù‘¶_Data_Memo_Write(E_YData(ii)): Call ProAddOn: Next ii
            Case Else
                        For ii = 1 To E_YDi:     Call SP_Šù‘¶_Data_ReWrite(E_YData(ii)): Call ProAddOn: Next ii
            End Select
            ...
            Case 1:
                        For ii = 1 To Šî‘bDi: Print #31, Text_•ÏŠ·s(Šî‘bData(ii)): Call ProAddOn: Next ii
                        Print #31, cr + cr + "         '[[[ Šù‘¶ ÃŞ°À@]]]"
                        For ii = 1 To E_Šî‘bDi:   Call SP_Šù‘¶_Data_Memo_Write(E_Šî‘bData(ii)): Call ProAddOn: Next ii
            Case Else
                        For ii = 1 To E_Šî‘bDi:   Call SP_Šù‘¶_Data_ReWrite(E_Šî‘bData(ii)): Call ProAddOn: Next ii
            End Select
            ...
            Case 1:
                        For ii = 1 To ’ŒDi: Print #31, Text_•ÏŠ·s(’ŒData(ii)): Call ProAddOn: Next ii
                        Print #31, cr + cr + "         '[[[ Šù‘¶ ÃŞ°À@]]]"
                        For ii = 1 To E_’ŒDi:    Call SP_Šù‘¶_Data_Memo_Write(E_’ŒData(ii)): Call ProAddOn: Next ii
            Case Else
                        For ii = 1 To E_’ŒDi:    Call SP_Šù‘¶_Data_ReWrite(E_’ŒData(ii)):  Call ProAddOn: Next ii
            End Select
            ...
            Case 1:
                        For ii = 1 To StoperDi: Print #31, Text_•ÏŠ·s(StoperData(ii)): Call ProAddOn: Next ii
                        Print #31, cr + cr + "         '[[[ Šù‘¶ ÃŞ°À@]]]"
                        For ii = 1 To E_StoperDi:  Call SP_Šù‘¶_Data_Memo_Write(E_StoperData(ii)): Call ProAddOn: Next ii
            Case Else
                        For ii = 1 To E_StoperDi:  Call SP_Šù‘¶_Data_ReWrite(E_StoperData(ii)): Call ProAddOn: Next ii
            End Select
            ...
            Case 1:
                        For ii = 1 To “¥ÀDi: Print #31, Text_•ÏŠ·s(“¥ÀData(ii)): Call ProAddOn: Next ii
                        Print #31, cr + cr + "         '[[[ Šù‘¶ ÃŞ°À@]]]"
                        For ii = 1 To E_“¥ÀDi:   Call SP_Šù‘¶_Data_Memo_Write(E_“¥ÀData(ii)): Call ProAddOn: Next ii
            Case Else
                        For ii = 1 To E_“¥ÀDi:   Call SP_Šù‘¶_Data_ReWrite(E_“¥ÀData(ii)): Call ProAddOn: Next ii
            End Select
            ...
            '[[[ }İ’è ]]]
                         For ii = 1 To }İ’èDi: Print #31, Text_•ÏŠ·s(}İ’èData(ii)): Call ProAddOn: Next ii
                        Print #31, cr + cr + "         '[[[ Šù‘¶ ÃŞ°À@]]]"
                        For ii = 1 To E_}İ’èDi:  Call SP_Šù‘¶_Data_Memo_Write(E_}İ’èData(ii)): Call ProAddOn: Next ii
    ...
    ZZZ5 = 0
    '[[[ •\¦Form_}–Ê‰æ–Ês ]]]
    If •\¦Form_}–Ê‰æ–Ês = "Y" Then }_‹´‹r_Auto•\¦s = "Y": Form_}–Ê‰æ–Ê.Show
...
Private Sub ‹´‹rData•ÏŠ·()
    ...
    Dim Šp“x1 As Single, Šp“x2 As Single
    
    Dim JointL As Single
    Dim Šî‘b_FX2_Joint_TYs As String '  W  K  J   N
    Dim Šî‘b_FX3_Joint_TYs As String '  W  K  J   N
    Dim Šî‘b_FY2_Joint_TYs As String '  W  K  J   N


   For ii = 0 To 6
       }_‹´‹r_‡”Ôi(ii) = pOutputPriority(ii)
       Next ii

   For ii = 0 To 6
       }_‹´‹r_–¼Ìs(ii) = gstrTitle & "_" & pOutputName(ii) '''05/04/11 gstrTitle & "_" & ‚ğ’Ç‰Á
       If }_‹´‹r_‡”Ôi(ii) <= 0 Then
            }_‹´‹r_–¼Ìs(ii) = ""
   ...
   For ii = 1 To 6: }_‹´‹r_•\¦–¼Ìs(ii) = ""
       For i2 = 1 To 6
       Select Case }_‹´‹r_‡”Ôi(i2)
       Case ii:  }_‹´‹r_•\¦–¼Ìs(ii) = pOutputName(i2) '}_‹´‹r_–¼Ìs(i2) '''05/04/11
       Case Else
       End Select
...
'„¤„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„£
      ...
      Lm = Lm + 1: YData(Lm) = "'[[[ K ‚Í Yå‹Ø ‚Å‚·  ]]]"
           ...
           Dim Yå‹Ø”í‚ès As String, Yå‹ØAnchorLs As String, Yå‹ØŒai As Single
           ...
           For ii = 1 To 2
              ...
              For i2 = 1 To 13 Step 3: If pKuiJiku(ii, i2) = 0 Then Exit For
                 Yå‹ØŒai = pKuiJiku(ii, i2)
             ' Test     If i2 = 7 Then Yå‹ØŒai = 16
                 
                 Yå‹ØŒas(ii) = Yå‹ØŒas(ii) + "-D" + f0(Yå‹ØŒai)
          ...
          '[[[ Hp ]]]
                     Lm = Lm + 1: YData(Lm) = "'[[[ Hp ‚Í Ì°Ìß“S‹Ø ‚Å‚·  ]]]   "
                     ...
                     Hoopí—Ş”i = Hoopí—Ş”i + 1
                     Hoop“S‹ØŒai = pKuiStr(ii, 1)
                     Hoop“S‹ØŒas(ii) = "D" + f0(Hoop“S‹ØŒai)
                     ...
                     End Select
                     Lm = Lm + 1:  YData(Lm) = "Hp=" + HoopStartˆÊ’us + Hoop“S‹ØŒas(ii) + Hoop’¼Œas(ii) + HoopPits(ii) + "_SD390"
                     HoopStartˆÊ’us = ""
          ...
          '[[[ Hp‘g—§‹Ø ]]]
                        Lm = Lm + 1: YData(Lm) = "'[[[ Hp‘g—§‹Ø ]]]"
                        Lm = Lm + 1: YData(Lm) = "' D    : “S‹ØŒa"
                        Lm = Lm + 1: YData(Lm) = "' SD   : Şís"
                        Lm = Lm + 1: YData(Lm) = "' Œa   : Ì°Ìß‚Ì ’¼Œa‚Å‚·"
                        Lm = Lm + 1: YData(Lm) = "' @    : ‘g—§‹Ø  Ëß¯Á‚Å‚·"

                      'old  Lm = Lm + 1: YData(Lm) = "'exp  ‘g—§‹Ø=D25_SD390_Œa1245_12_32_52_69_86_99_112   "

                Dim ‘g—§‹ØŒas As String, ‘g—§‹Ø’¼Œas As String, ‘g—§‹Øpits As String, ‘g—§‹ØˆÊ’us As String
                ‘g—§‹ØŒas = "D" + f0(pKuiKumiDai(1))
                ‘g—§‹Ø’¼Œas = "_Œa" + F9(pKuikei - 2 * Yå‹Øƒ”í‚è + pKuiKumiDai(1))
                ‘g—§‹Øpits = "_@" + pKuiKumitateW(1)


                Lm = Lm + 1:  YData(Lm) = "Hp‘g—§‹Ø=" + ‘g—§‹ØŒas + ‘g—§‹Ø’¼Œas + ‘g—§‹Øpits + "_SD390"
          ...
          '[[[ Hoop’ê‹Ø ]]]
                       ...
                       Lm = Lm + 1: YData(Lm) = "'exp      Hp’ê=8-D25_L837_SD390    "
              Lm = Lm + 1:  YData(Lm) = "Hp’ê=8-D25_L837_SD390"
...
'„¤„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„£
      ...
      Šî‘b_FX2_Joint_TYs = "W"
      Šî‘b_FX3_Joint_TYs = "J"
      Šî‘b_FY2_Joint_TYs = "J"
    ...
    'Lm = Lm + 1: Šî‘bData(Lm) = "errck" '***
        ...
        '[[[ ŒXÎ data  ]]]
                         Lm = Lm + 1: Šî‘bData(Lm) = "'[[[ ŒXÎ data   K3,K5, L1,L2,h1  ]]]"

                    Lm = Lm + 1: Šî‘bData(Lm) = "ŒXÎ=" + F9(K3) + "_" + F9(K5) + "_" + F9(L1) + "_" + F9(L2) + "_" + F9(h1)



        '[[[ FYn ‚Í Y•ûŒü“S‹Ø ‚Å‚·  ]]]
                         Lm = Lm + 1: Šî‘bData(Lm) = "'[[[ FYn ‚Í Y•ûŒü“S‹Ø ‚Å‚·  ]]]"
                         ...
                         Lm = Lm + 1: Šî‘bData(Lm) = "'exp  FY1=D32_K95_@95+155+80x125+155_BF+10014+F_SD390                          'Y ’ê“S‹Ø  @Ëß¯Á‚Í‘¤–Ê‚©‚ç"
                         Lm = Lm + 1: Šî‘bData(Lm) = "'exp  FY2=D32_K95_@95+155+80x125+155_B3563+1092+W+2092+3563_H2328+483_SD390    'Y ã“S‹Ø  @Ëß¯Á‚Í‘¤–Ê‚©‚ç"
                         Lm = Lm + 1: Šî‘bData(Lm) = "'exp  FY3=D19_K69.5_@200+9x200_B10361_H190_SD390                               'Y …•½•â‹­‹Ø  @Ëß¯Á‚Í‰º‚©‚ç"

                    Dim Šî‘b“S‹ØŒas As String, Šî‘bdts As String, Šî‘b“S‹ØPits As String, Šî‘b“S‹ØBs As String, Šî‘b“S‹ØBi As Single, Šî‘b“S‹ØHs As String, Šî‘b“S‹ØHi As Single
                    Dim Šî‘b“S‹ØGs As String ' Šî‘b“S‹ØBs ‚Ì•½–Ê—p
                    Dim Šî‘b“S‹ØZs  As String
                    'Dim Šî‘b“S‹Ø‚Ì’·‚³i As Single, Šî‘b“S‹Ø‚Ì‚‚³i As Single

               '<<< Y ’ê“S‹Ø >>>"  ' FY1   (F1)
                    Lm = Lm + 1: Šî‘bData(Lm) = "'<<< Y ’ê“S‹Ø >>>"  ' FY1   (F1)
                    
                    Šî‘b“S‹ØŒas = "D" + f0(pKisoDai(3))
                    Šî‘bdts = "_K" + F9(K2)
                    Šî‘b“S‹ØPits = "_@" + Replace®s(pKisoPictW(3))
                   'Šî‘b“S‹ØBs
                        Fook_ri = FP_‹´‹r_“S‹Ø_Data("D1", "SD390", "•W€", Šî‘b“S‹ØŒas) / 2
                        Šî‘b“S‹ØBi = Šî‘b_BY - 2 * (K3 + pKisoDai(1) / 2 + pKisoDai(3) / 2 + Fook_ri):
                        Šî‘b“S‹ØBs = "_BF+" + F9(Šî‘b“S‹ØBi) + "+F"
                    Lm = Lm + 1: Šî‘bData(Lm) = "FY1=" + Šî‘b“S‹ØŒas + Šî‘bdts + Šî‘b“S‹ØPits + Šî‘b“S‹ØBs + "_SD390"

               '<<< Y ã“S‹Ø >>>"   'FY2   (F2)
                    Lm = Lm + 1: Šî‘bData(Lm) = "'<<< Y ã“S‹Ø >>>"   'FY2   (F2)
                    Šî‘b“S‹ØŒas = "D" + f0(pKisoDai(1))
                    Šî‘bdts = "_K" + F9(K1) ' F9(Šî‘b_ãƒ”í‚è + pKisoDai(1) / 2)
                    Šî‘b“S‹ØPits = "_@" + Replace®s(pKisoPictW(1))
                   'Šî‘b“S‹ØBs
                    
                          Šî‘b“S‹ØBi = 2 * L1 + L2 ' Šî‘b_BY - 2 * K3
                          Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi)
                          Šî‘b“S‹ØGs = "_G" + F9(Šî‘b“S‹ØBi)  ' •K—v
                          LL1 = Sqr(L1 ^ 2 + h1 ^ 2)
                          
                          If 2 * h2 + 2 * LL1 + L2 <= 12000 Then Šî‘b_FY2_Joint_TYs = ""
                          
                          
                          Select Case Šî‘b_FY2_Joint_TYs
                          Case "W":   Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi / 2 + 500) + "+W+" + F9(Šî‘b“S‹ØBi / 2 - 500)
                          Case "K":   Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi / 2 + 500) + "+K+" + F9(Šî‘b“S‹ØBi / 2 - 500)
                          Case "J":   Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi / 2 + 500) + "+J" + F9(JointL) + "+" + F9(Šî‘b“S‹ØBi / 2 - 500 + JointL)
                          Case Else: Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi)
                          End Select
                   
                   
                   
                   If Šî‘b_H2 > 0 Then
                          JointL = FP_‹´‹r_“S‹Ø_Data("KHL", "SD390", "•W€", Šî‘b“S‹ØŒas)
                          Call caluŠp“x1(0, 0, L1, h1, Šp“x2)
                          Šp“x1 = 90 - Šp“x2
                          
                          Select Case Šî‘b_FY2_Joint_TYs
                          Case "W":   Šî‘b“S‹ØBs = F9(L2 / 2 + 500) + "+W+" + F9(L2 / 2 - 500)
                                      Šî‘b“S‹ØGs = "_G" + F9(Šî‘b“S‹ØBi / 2 + 500) + "+W+" + F9(Šî‘b“S‹ØBi / 2 - 500)
                          
                          Case "K":   Šî‘b“S‹ØBs = F9(L2 / 2 + 500) + "+K+" + F9(L2 / 2 - 500)
                                      Šî‘b“S‹ØGs = "_G" + F9(Šî‘b“S‹ØBi / 2 + 500) + "+K+" + F9(Šî‘b“S‹ØBi / 2 - 500)
                          
                          Case "J":   Šî‘b“S‹ØBs = F9(L2 / 2 + 500) + "+J" + F9(JointL) + "+" + F9(L2 / 2 - 500 + JointL)
                                      Šî‘b“S‹ØGs = "_G" + F9(Šî‘b“S‹ØBi / 2 + 500) + "+J" + F9(JointL) + "+" + F9(Šî‘b“S‹ØBi / 2 - 500 + JointL)
                          
                          Case Else:  Šî‘b“S‹ØBs = F9(L2)
                                      Šî‘b“S‹ØGs = "_G" + F9(Šî‘b“S‹ØBi)
                          
                          End Select
                       
                          Šî‘b“S‹ØBs = "_B+Šp" + F9(Šp“x1) + "+" + F9(LL1) + "+Šp" + F9(Šp“x2) + "+" + Šî‘b“S‹ØBs + "+Šp" + F9(Šp“x2) + "+" + F9(LL1) + "+Šp" + F9(Šp“x1)
                   
                          End If
                   
                   
                   'Šî‘b“S‹ØHs
                    Šî‘b“S‹ØHi = h2 ' Šî‘b_H1 - Šî‘b_ãƒ”í‚è - pKisoDai(1)
                    'OK = Šî‘b“S‹ØHi = pH(6) + pH(5) - K1 - h1 - h3
                    Šî‘b“S‹ØHs = "_H" + F9(Šî‘b“S‹ØHi)
                    Šî‘b“S‹ØZs = "_Z" + F9(-K6) '+ F9(-h1 - K1)
                    Lm = Lm + 1: Šî‘bData(Lm) = "FY2=" + Šî‘b“S‹ØŒas + Šî‘bdts + Šî‘b“S‹ØPits + Šî‘b“S‹ØBs + Šî‘b“S‹ØGs + Šî‘b“S‹ØHs + Šî‘b“S‹ØZs + "_SD390"
                     Šî‘b“S‹ØZs = ""

               '<<< Y …•½•â‹­‹Ø >>>"  'FY3   (F3)
                    Lm = Lm + 1: Šî‘bData(Lm) = "'<<< Y …•½•â‹­‹Ø >>>"  'FY3   (F3)
                    Šî‘b“S‹ØŒas = "D" + f0(pKisoDai(9))
                    Šî‘bdts = "_K" + F9(Šî‘b_‰¡ƒ”í‚è + pKisoDai(9) / 2)
                    Šî‘b“S‹ØPits = "_@" + Replace®s(pKisoPictW(9))
                    Šî‘b“S‹ØBi = Šî‘b_BY - 2 * Šî‘b_‰¡ƒ”í‚è - pKisoDai(9):      Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi)
                    Šî‘b“S‹ØHi = 30 * pKisoDai(9):                               Šî‘b“S‹ØHs = "_H" + F9(Šî‘b“S‹ØHi)
                    Lm = Lm + 1: Šî‘bData(Lm) = "FY3=" + Šî‘b“S‹ØŒas + Šî‘bdts + Šî‘b“S‹ØPits + Šî‘b“S‹ØBs + Šî‘b“S‹ØHs + "_SD390"


        '[[[ FXn ‚Í X•ûŒü“S‹Ø ‚Å‚·  ]]]
                         Lm = Lm + 1: Šî‘bData(Lm) = "'[[[ FXn ‚Í X•ûŒü“S‹Ø ‚Å‚·  ]]]"
                         Lm = Lm + 1: Šî‘bData(Lm) = "' D    : “S‹ØŒa          exp D32"
                         Lm = Lm + 1: Šî‘bData(Lm) = "' K    : ”í‚è‚Ì “S‹ØˆÊ’u‚Å‚·  ƒ”íØ"
                         ...
                         Lm = Lm + 1: Šî‘bData(Lm) = "'exp   FX1=D32_K127_@127+123+80x125+123_BF+10014+F_SD390              'X ’ê“S‹Ø  @Ëß¯Á‚Í‘¤–Ê‚©‚ç"
                         Lm = Lm + 1: Šî‘bData(Lm) = "'exp   FX2=D32_K127_@127+123+80x125+123_B5655+W+4655_H2746_SD390      'X ã“S‹Ø  @Ëß¯Á‚Í‘¤–Ê‚©‚ç"
                         Lm = Lm + 1: Šî‘bData(Lm) = "'exp   FX3=D32_K127_B5655+W+4655_H2746`2246_SD390                    'X ã“S‹Ø  @Ëß¯Á‚Í FX2 ‚Å’è‹`"
                         Lm = Lm + 1: Šî‘bData(Lm) = "'exp   FX4=D19_K69.5_@300+8x200_B10361_H190_SD390                     'X …•½•â‹­‹Ø  @Ëß¯Á‚Í‰º‚©‚ç"


               '<<< X ’ê“S‹Ø >>>"  ' F11
                    Lm = Lm + 1: Šî‘bData(Lm) = "'<<< X ’ê“S‹Ø >>>"  ' F11
                    Šî‘b“S‹ØŒas = "D" + f0(pKisoDai(7))
                    Šî‘bdts = "_K" + F9(K12) 'F9(Šî‘b_‰ºƒ”í‚è + pKisoDai(7) / 2)
                    Šî‘b“S‹ØPits = "_@" + Replace®s(pKisoPictW(7))
                   'Šî‘b“S‹ØBs
                        Fook_ri = FP_‹´‹r_“S‹Ø_Data("D1", "SD390", "•W€", Šî‘b“S‹ØŒas) / 2
                        L11 = K13 + pKisoDai(3) / 2 + pKisoDai(7) / 2 + Fook_ri:    L12 = pW(7) - 2 * L11
                        
                        Šî‘b“S‹ØBs = "_BF+" + F9(L12) + "+F"
                    Lm = Lm + 1: Šî‘bData(Lm) = "FX1=" + Šî‘b“S‹ØŒas + Šî‘bdts + Šî‘b“S‹ØPits + Šî‘b“S‹ØBs + "_SD390"

               '<<< X ã“S‹Ø FX2 >>>"  ' F12 (’Œ‹æŠÔ)
                    Lm = Lm + 1: Šî‘bData(Lm) = "'<<< X ã“S‹Ø >>>"  ' F12
                    Šî‘b“S‹ØŒas = "D" + f0(pKisoDai(5))
                    Šî‘bdts = "_K" + F9(K11)
                    Šî‘b“S‹ØPits = "_@" + Replace®s(pKisoPictW(5))
                    Šî‘b“S‹ØBi = Šî‘b_BX - 2 * K13
                    Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi) '5655+W+4655"
                          JointL = FP_‹´‹r_“S‹Ø_Data("KHL", "SD390", "•W€", Šî‘b“S‹ØŒas)
                
                          If 2 * h4 + Šî‘b“S‹ØBi <= 12000 Then Šî‘b_FX2_Joint_TYs = ""
                
                          Select Case Šî‘b_FX2_Joint_TYs
                          Case "W":   Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi / 2 + 500) + "+W+" + F9(Šî‘b“S‹ØBi / 2 - 500)
                          Case "K":   Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi / 2 + 500) + "+K+" + F9(Šî‘b“S‹ØBi / 2 - 500)
                          Case "J":   Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi / 2 + 500) + "+J" + F9(JointL) + "+" + F9(Šî‘b“S‹ØBi / 2 - 500 + JointL)
                          Case Else: Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi)
                   ...
                   'Šî‘b“S‹ØHs
                          Šî‘b“S‹ØHi = h4
                          Šî‘b“S‹ØHs = "_H" + F9(Šî‘b“S‹ØHi)
                    Lm = Lm + 1: Šî‘bData(Lm) = "FX2=" + Šî‘b“S‹ØŒas + Šî‘bdts + Šî‘b“S‹ØPits + Šî‘b“S‹ØBs + Šî‘b“S‹ØHs + "_SD390"

               
               '<<< X ã“S‹Ø FX3 >>>" ' Data‚ª ‚È‚¢ê‡ F13    F12  auto@‚æ‚èì¬
                    ...
                    Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi)
                          ...
                          If 2 * h4 + Šî‘b“S‹ØBi <= 12000 Then Šî‘b_FX3_Joint_TYs = ""
                
                          Select Case Šî‘b_FX3_Joint_TYs
                          Case "W":   Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi / 2 + 500) + "+W+" + F9(Šî‘b“S‹ØBi / 2 - 500)
                          Case "K":   Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi / 2 + 500) + "+K+" + F9(Šî‘b“S‹ØBi / 2 - 500)
                          Case "J":   Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi / 2 + 500) + "+J" + F9(JointL) + "+" + F9(Šî‘b“S‹ØBi / 2 - 500 + JointL)
                          Case Else: Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi)
                   ...
                   ' Šî‘b“S‹ØHs = "_H2746`2246"
                    Šî‘b“S‹ØHs = "" ' Auto ŒvZ
                    Lm = Lm + 1: Šî‘bData(Lm) = "FX3=" + Šî‘b“S‹ØŒas + Šî‘bdts + Šî‘b“S‹ØBs + Šî‘b“S‹ØHs + "_SD390"

               '<<< X …•½•â‹­‹Ø >>>"  ' F14
                    Lm = Lm + 1: Šî‘bData(Lm) = "'<<< X …•½•â‹­‹Ø >>>"  ' F14
                    Šî‘b“S‹ØŒas = "D" + f0(pKisoDai(9))
                    Šî‘bdts = "_K" + F9(K3 - pKisoDai(9) / 2 - pKisoDai(1) / 2) '+ F9(Šî‘b_‰¡ƒ”í‚è + pKisoDai(9) / 2 ) ' ’²®
                    Šî‘b“S‹ØPits = "_@" + Replace®s(pKisoPictW(9))
                    Šî‘b“S‹ØBi = Šî‘b_BX - 2 * Šî‘b_‰¡ƒ”í‚è - pKisoDai(9):     Šî‘b“S‹ØBs = "_B" + F9(Šî‘b“S‹ØBi)
                    Šî‘b“S‹ØHi = 30 * pKisoDai(9):                              Šî‘b“S‹ØHs = "_H" + F9(Šî‘b“S‹ØHi)
                    Lm = Lm + 1: Šî‘bData(Lm) = "FX4=" + Šî‘b“S‹ØŒas + Šî‘bdts + Šî‘b“S‹ØPits + Šî‘b“S‹ØBs + Šî‘b“S‹ØHs + "_SD390"
         ...
         '[[[ Šî‘b ½À°×¯Ìß ]]]
                    ...
                    Lm = Lm + 1: Šî‘bData(Lm) = "'[[[ St ‚Í c“S‹Ø ‚Å‚· ½À°×¯Ìß ]]]"
                         Lm = Lm + 1: Šî‘bData(Lm) = "' D    : “S‹ØŒa     exp D19"

                         Lm = Lm + 1: Šî‘bData(Lm) = "' K    : ”íØ‚Ì “S‹ØˆÊ’u(dt)‚Å‚·"
                         Lm = Lm + 1: Šî‘bData(Lm) = "' B    : “S‹Ø‚Ì•‚Å‚·   “S‹Ø‚ÌPit "
                         Lm = Lm + 1: Šî‘bData(Lm) = "' H    : “S‹Ø‚Ì‚‚³‚Å‚·"
                         Lm = Lm + 1: Šî‘bData(Lm) = "' SD   : Şí"
                         ' Y•ûŒü ü˜H•ûŒü
                         '       St_ü˜H•ûŒü=D19_K69_H2804+F_SD390
                         '       St_ü˜H•ûŒüPit=750+16x125
                         '       St_ü˜H•ûŒüŠ„•t=250+5x(750+500)+1250
                         
                   ' Y•ûŒü ü˜H•ûŒü f1
                         Šî‘b_St_Œai = pKisoStrDai(1)
                         Fook_ri = FP_‹´‹r_“S‹Ø_Data("D1", "SD390", "‘Ñ‹Ø", "D" + F9(Šî‘b_St_Œai)) / 2
                         Šî‘b_St_dts = "_K" + F9(K2 - pKisoDai(3) / 2 - Šî‘b_St_Œai / 2) 'F9(pKisoKaburi(2) + Šî‘b_St_Œai / 2)
                         D1s = Replace®s(pKisoStrPictW(2)): D1s = F_ŒvZ_•ª‰ğ(D1s)
                             Call Ddata_D("+", D1s, Di, ni)
                         Šî‘b_St_Bi = Di(2)
                             Šî‘b_St_Bs = "_B" + F9(Šî‘b_St_Bi)
                         
                         
                       '  Šî‘b_St_Hi = hx1 + (D1 + D2) / 2 + D0 - Fr
                         Šî‘b_St_Hi = pH(6) - K2 - K4 + (pKisoDai(1) + pKisoDai(3)) / 2 + Šî‘b_St_Œai - Fook_ri
'                             Šî‘b_St_Hs = "_H" + F9(Šî‘b_St_Hi) + "+F"
'                             Šî‘b_St_H2i = Šî‘b_H1 - Šî‘b_ãƒ”í‚è - Šî‘b_‰ºƒ”í‚è - Šî‘b_St_Œai / 2
'                             If Šî‘b_H1 > 0 Then Šî‘b_St_Hs = "_H" + F9(Šî‘b_St_H2i) + "`" + F9(Šî‘b_St_Hi) + "+F"
                         
                         Šî‘b_St_Hs = "_H" + F9(-Šî‘b_St_Hi) ' - ‚Ìê‡ Šî‘b_St_Hi(hx0) ‚©‚ç Auto ŒvZ
                         
                         Lm = Lm + 1: Šî‘bData(Lm) = "St_ü˜H•ûŒü=D" + f0(Šî‘b_St_Œai) + Šî‘b_St_dts + Šî‘b_St_Bs + Šî‘b_St_Hs + "_SD390"
                         Lm = Lm + 1: Šî‘bData(Lm) = "St_ü˜H•ûŒüPit=" + Replace®s(pKisoStrPictW(1))
                         Lm = Lm + 1: Šî‘bData(Lm) = "St_ü˜H•ûŒüŠ„•t=" + Replace®s(pKisoStrPictW(2))
                         If pKisoStrPictW(3) <> "" Then Lm = Lm + 1: Šî‘bData(Lm) = "St_ü˜H•ûŒüŠ„•t=" + Replace®s(pKisoStrPictW(3))
                         Lm = Lm + 1: Šî‘bData(Lm) = ""
                         
                   ' Y•ûŒü ’¼Šp•ûŒü  f2
                         Šî‘b_St_Œai = pKisoStrDai(2)
                         Fook_ri = FP_‹´‹r_“S‹Ø_Data("D1", "SD390", "‘Ñ‹Ø", "D" + F9(Šî‘b_St_Œai)) / 2
                         Šî‘b_St_dts = "_K" + F9(K12 - pKisoDai(7) / 2 - Šî‘b_St_Œai / 2) ' F9(pKisoKaburi(2) + Šî‘b_St_Œai / 2)
                         D1s = Replace®s(pKisoStrPictW(5)): D1s = F_ŒvZ_•ª‰ğ(D1s)
                             Call Ddata_D("+", D1s, Di, ni)
                         Šî‘b_St_Bi = Di(2)
                             Šî‘b_St_Bs = "_B" + F9(Šî‘b_St_Bi)
                             
                         Šî‘b_St_Hi = pH(5) + pH(6) - K11 - K12 + (pKisoDai(5) + pKisoDai(7)) / 2 + Šî‘b_St_Œai - Fook_ri
...
'„  ¡ ’Œ                                                                                                                  „ 
'„¤„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„£
                       Dim ’Œ_BX As Single, ’Œ_BY As Single, ’Œ_H As Single, ’Œƒ”íi As Single
                       Dim ’Œå‹Ø_XŒai As Single, ’Œå‹Ø_YŒai As Single, ’Œå‹Ø_TY_Xi As Integer, ’Œå‹Ø_TY_Yi As Integer
                       Dim ’Œå‹Ø_L As Single, ’Œå‹Ø_L2 As Single
                       Dim ’Œå‹ØStartˆÊ’ui As Single, ’Œå‹ØStartˆÊ’us As String
                       ...
                       ’Œ_H = pH(4)
                       ’Œƒ”íi = pkuitaiKaburi(1)
                       ’Œå‹Ø_XŒai = pkuitaiDai(2): ’Œå‹Ø_YŒai = pkuitaiDai(1)
        ...
        Lm = Lm + 1: ’ŒData(Lm) = "r=0"       ' r=0 'r=250        '?   r=    : ’Œr
                 ...
                 '„¤„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„£
                  ...
                  ’Œå‹Ø_TY_Xi = 1: If pkuitaiPictW(2) <> "" Then ’Œå‹Ø_TY_Xi = 2
                  ’Œå‹Ø_TY_Yi = 1: If pkuitaiPictW(4) <> "" Then ’Œå‹Ø_TY_Yi = 2
                 
                 
                 '[[[ ’Œå‹ØType ]]]
                      Dim ’Œå‹Øs As String, ’Œå‹Ø”í‚ès As String, ’Œå‹Ø_1’i–Ú’·‚³s As String, ’Œå‹Ø_2’i–Ú’·‚³s As String
                      ’Œå‹Øs = "D" + f0(pkuitaiDai(1))
                      Call SP_’Œ_å‹Ø_H("SD390", ’Œå‹Øs, ’Œå‹ØStartˆÊ’ui, ’Œå‹Ø_L, ’Œå‹Ø_L2)
                      
                      ’Œå‹ØStartˆÊ’us = "_P" + F9(’Œå‹ØStartˆÊ’ui)
                      ’Œå‹Ø”í‚ès = "_K" + F9(’Œƒ”íi + ’ŒHp_ŠOŠªŒai + pkuitaiDai(1) / 2)
                    '  ’Œå‹Ø_1’i–Ú’·‚³s = "_LF+11420+W+2200"  '**********
                      ’Œå‹Ø_1’i–Ú’·‚³s = "_LF+" + f0(’Œå‹Ø_L)
                      ’Œå‹Ø_2’i–Ú’·‚³s = "_LF+" + f0(’Œå‹Ø_L2)
                      
                      
                      Select Case ’Œå‹Ø_TY_Xi
                           Case 1
                                      Lm = Lm + 1: ’ŒData(Lm) = "C=" + ’Œå‹Øs + ’Œå‹ØStartˆÊ’us + ’Œå‹Ø”í‚ès + ’Œå‹Ø_1’i–Ú’·‚³s + "_SD390"
                           Case Else
                                      Lm = Lm + 1: ’ŒData(Lm) = "C=" + ’Œå‹Øs + ’Œå‹ØStartˆÊ’us + ’Œå‹Ø”í‚ès + ’Œå‹Ø_1’i–Ú’·‚³s + "_SD390"
                                      Lm = Lm + 1: ’ŒData(Lm) = "C=" + ’Œå‹Øs + ’Œå‹ØStartˆÊ’us + ’Œå‹Ø”í‚ès + ’Œå‹Ø_2’i–Ú’·‚³s + "_SD390"
                           End Select
                      
                      ’Œå‹Øs = "D" + f0(pkuitaiDai(2))
                      Call SP_’Œ_å‹Ø_H("SD390", ’Œå‹Øs, ’Œå‹ØStartˆÊ’ui, ’Œå‹Ø_L, ’Œå‹Ø_L2)
                      ’Œå‹ØStartˆÊ’us = "_P" + F9(’Œå‹ØStartˆÊ’ui)
                      ’Œå‹Ø”í‚ès = "_K" + F9(’Œƒ”íi + ’ŒHp_ŠOŠªŒai + pkuitaiDai(2) / 2)
                     ' ’Œå‹Ø_1’i–Ú’·‚³s = "_LF+11420+W+2200"  '**********
                      ’Œå‹Ø_1’i–Ú’·‚³s = "_LF+" + f0(’Œå‹Ø_L)
                      ’Œå‹Ø_2’i–Ú’·‚³s = "_LF+" + f0(’Œå‹Ø_L2)
                      Select Case ’Œå‹Ø_TY_Yi
                           Case 1
                                      Lm = Lm + 1: ’ŒData(Lm) = "C=" + ’Œå‹Øs + ’Œå‹ØStartˆÊ’us + ’Œå‹Ø”í‚ès + ’Œå‹Ø_1’i–Ú’·‚³s + "_SD390"
                           Case Else
                                      Lm = Lm + 1: ’ŒData(Lm) = "C=" + ’Œå‹Øs + ’Œå‹ØStartˆÊ’us + ’Œå‹Ø”í‚ès + ’Œå‹Ø_1’i–Ú’·‚³s + "_SD390"
                 ...
                 '[[[ ’Œå‹Ø”z’u ]]]
                      ...
                      Xå‹Øs = "Xå‹Ø=" + f0(Xå‹Øi) + "xC1"
                             If Trim(pkuitaiPictW(2)) <> "" Then Xå‹Øs = Xå‹Øs + "_" + f0(FP_DataŒÂ”i(pkuitaiPictW(1))) + "xC2"
                      
                      Yå‹Øi = FP_DataŒÂ”i(pkuitaiPictW(3))
                      Yå‹Øs = "Yå‹Ø=" + f0(Yå‹Øi) + "xC" + f0(’Œå‹Ø_TY_Xi + 1)
                             If Trim(pkuitaiPictW(4)) <> "" Then Yå‹Øs = Yå‹Øs + "_" + f0(FP_DataŒÂ”i(pkuitaiPictW(4))) + "xC" + f0(’Œå‹Ø_TY_Xi + 2)
...
'                         Lm = Lm + 1: ’ŒData(Lm) = "CK=11-D16_K101_L480_SD390                    ' ### —À‰º•” •â‹­‹Ø"
                 ...
                 '„¤„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„£
                  '[[[ ’Œ Ì°Ìß ]]]
                       Dim ’ŒHp_Start As Single ' Šî‘b‰ºê‚©‚ç Hp Start ˆÊ’u‚Ì H
                  ...
                  '[[[ ŠOüÌ°Ìß ]]]
                         ...
                         Lm = Lm + 1: ’ŒData(Lm) = "'[[[ ŠOHp ‚Í ŠOüÌ°Ìß ‚Å‚·  ]]]"
                         ...
                         Lm = Lm + 1: ’ŒData(Lm) = "' R    : “S‹Ø‚Ì r<0 ‚Ìê‡@ir-10 ‚Å“ü—Í)   r1 ‚Ì’l‚Å‚·   "
                         Lm = Lm + 1: ’ŒData(Lm) = "' SD   : Şí"

                         Lm = Lm + 1: ’ŒData(Lm) = "'exp   ŠOHp=D22_K75_X3858_Y1120x2858_@1200+6x200+4x150+72x150_SD390"
                         Dim ’ŒŠOüSt_Ds As String, ’ŒŠOüSt_Ks As String, ’ŒŠOüSt_Xs As String, ’ŒŠOüSt_Ys As String, ’ŒŠOüSt_Pits As String, ’ŒŠOüSt_Rs As String
                               ’ŒŠOüSt_Ds = "D" + f0(’ŒHp_ŠOŠªŒai)
                               ’ŒŠOüSt_Ks = "_K" + F9(pkuitaiKaburi(1) + ’ŒHp_ŠOŠªŒai / 2)
                               ’ŒŠOüSt_Xs = "_X" + F9(’Œ_BX - 150)
                               ’ŒŠOüSt_Ys = "_Y" + F9(1000) + "x" + F9(’Œ_BY - 150)
                               D1s = F9(’ŒHp_Start)
                   ...
                   'If ’ŒHp_ŠOŠªpit(4) = 0 Then ’ŒHp_ŠOŠªpit(4) = 150 '*************
                         ...
                         Lm = Lm + 1: ’ŒData(Lm) = "ŠOHp=" + ’ŒŠOüSt_Ds + ’ŒŠOüSt_Ks + ’ŒŠOüSt_Xs + ’ŒŠOüSt_Ys + ’ŒŠOüSt_Pits + "_SD390"
                    ...
                    '[[[ X•ûŒü(’¼Šp•ûŒü) “à‘¤Ì°Ìß ]]]
                      Lm = Lm + 1: ’ŒData(Lm) = "'[[[ “àHp_X ‚Í ’¼Šp•ûŒü(X•ûŒü) “à‘¤Ì°Ìß ‚Å‚·  ]]]"
                          ...
                          '          “àHp_X_Ypit=750+5x625|1+500|2               ’Œ¶’[‚©‚ç   Pit|HpType    Pit ’†S‚ÌˆÊ’u    HpTypeÈ—ª‚Ì‚Î‚ ‚¢ 1
                          '          “àHp_X_Ypit=500+5x625|1+500|2
                          '          “àHp_X_”z’u=50x1,2+3x3                     Xpit ‚Ìw’è ‰º-->ã    È—ª‚Ì‚Î‚ ‚¢  Xpit(1)
                          '
                     
                           Dim ’ŒHp_X_Œai As Single, ’ŒHp_X_B As Single
                           Dim ’ŒHp_X_Pit_1s As String, ’ŒHp_X_Pit_2s As String
                           Dim ’ŒHp_X_HPitni As Integer, ’ŒHp_X_Joint_Li As Single
                          ...
                          '[[[ X•ûŒü “à‘¤Ì°Ìß D ]]]
                                ...
                                ’ŒHp_X_B = ’Œ_BX - 2 * ’Œƒ”íi - ’ŒHp_X_Œai
                          
                          '[[[ Y•ûŒü “à‘¤Ì°Ìß•”•i Type ]]]
                                Dim ’ŒHp_X_Typei As Integer, ’ŒHp_X_D(90) As Single
                                ’ŒHp_X_Typei = 0
                                Wda = F_ŒvZ_•ª‰ğ(’ŒHp_X_Pit_1s):    Call Ddata_M("+", Wda, Ds, ni)
                                ...
                                Wda = F_ŒvZ_•ª‰ğ(’ŒHp_X_Pit_2s):    Call Ddata_M("+", Wda, Ds, ni)
                                For ii = 2 To ni Step 2:      DD = Val(Ds(ii)): CKs = "New"
                                    For i2 = 1 To ’ŒHp_X_Typei:  If DD = ’ŒHp_X_D(i2) Then CKs = "": Exit For
                                         Next i2
                                         If CKs = "New" Then ’ŒHp_X_Typei = ’ŒHp_X_Typei + 1: ’ŒHp_X_D(’ŒHp_X_Typei) = DD
                                ...
                                ’ŒHp_X_Joint_Li = FP_‹´‹r_“S‹Ø_Data("KHL", "SD390", "‘Ñ‹Ø", "D" + f0(’ŒHp_X_Œai)) ' ** **
                                For ii = 1 To ’ŒHp_X_Typei
                                    Wda = "D" + f0(’ŒHp_X_Œai)
                                   ' Wda = Wda + "_B" + F9(’ŒHp_X_B)
                                    
                                    Wda = Wda + "_B" + F9(’ŒHp_X_B / 2 + ’ŒHp_X_Joint_Li) + "+J" + F9(’ŒHp_X_Joint_Li) + "+" + F9(’ŒHp_X_B / 2 - ’ŒHp_X_Joint_Li)
                                    Wda = Wda + "_D" + F9(’ŒHp_X_D(ii) + pkuitaiDai(2) + ’ŒHp_X_Œai)
                                    Lm = Lm + 1: ’ŒData(Lm) = "“àHp_X_•”•i=" + Wda + "_SD390"
                                    Next ii
                          
                          '[[[ X•ûŒü “à‘¤Ì°Ìß Ypit ]]]
                                Wda = F_ŒvZ_•ª‰ğ(’ŒHp_X_Pit_1s):    Call Ddata_D("+", Wda, Di, ni)
                                Wda = ""
                                ...
                                Wda = F_ŒvZ_•ª‰ğ(’ŒHp_X_Pit_2s):    Call Ddata_D("+", Wda, Di, ni)
                                Wda = ""
                                For ii = 2 To ni Step 2:  TYi = 1: Piti = Di(ii - 2) / 2 + Di(ii - 1) + Di(ii) / 2
                                    For i2 = 1 To ’ŒHp_X_Typei:  If Di(ii) = ’ŒHp_X_D(i2) Then TYi = i2: Exit For
                                        Next i2
                          ...
                          '[[[ Y•ûŒü “à‘¤Ì°Ìß ”z’u ]]]
                              '’ŒHp_Y_HPitni
                     '          “àYHpH”z’u=50x1,2+3x3                     Xpit ‚Ìw’è ‰º-->ã    È—ª‚Ì‚Î‚ ‚¢  Xpit(1)
...
'                         Lm = Lm + 1: ’ŒData(Lm) = "' SD   : Şí"
                   ...
                   '[[[ ü˜H•ûŒü Y•ûŒü “à‘¤Ì°Ìß ]]]
                      Lm = Lm + 1: ’ŒData(Lm) = "'[[[ “àHp_Y ‚Í ü˜H•ûŒü(Y•ûŒü “à‘¤Ì°Ìß) ‚Å‚·  ]]]"
                          ...
                          '          “àHp_Y_Xpit=750+5x625|1+500|2               ’Œ¶’[‚©‚ç   Pit|HpType    Pit ’†S‚ÌˆÊ’u    HpTypeÈ—ª‚Ì‚Î‚ ‚¢ 1
                          '          “àHp_Y_Xpit=500+5x625|1+500|2
                          '          “àHp_Y_”z’u=50x1,2+3x3                     Xpit ‚Ìw’è ‰º-->ã    È—ª‚Ì‚Î‚ ‚¢  Xpit(1)
                          '
                     
                           Dim ’ŒHp_Y_Œai As Single, ’ŒHp_Y_D As Single
                           Dim ’ŒHp_Y_Pit_1s As String, ’ŒHp_Y_Pit_2s As String
                           Dim ’ŒHp_Y_HPitni As Integer, ’ŒHp_Y_Joint_Li As Single
                          ...
                          '[[[ Y•ûŒü “à‘¤Ì°Ìß D ]]]
                                ’ŒHp_Y_D = ’Œ_BY - 2 * ’Œƒ”íi - ’ŒHp_Y_Œai
                          
                          '[[[ Y•ûŒü “à‘¤Ì°Ìß Type ]]]
                                Dim ’ŒHp_Y_Typei As Integer, ’ŒHp_Y_B(90) As Single
                                ’ŒHp_Y_Typei = 0
                                Wda = F_ŒvZ_•ª‰ğ(’ŒHp_Y_Pit_1s):    Call Ddata_M("+", Wda, Ds, ni)
                                For ii = 2 To ni Step 2:      BB = Val(Ds(ii)): CKs = "New"
                                    ...
                                    Next ii
                                Wda = F_ŒvZ_•ª‰ğ(’ŒHp_Y_Pit_2s):    Call Ddata_M("+", Wda, Ds, ni)
                                For ii = 2 To ni Step 2:      BB = Val(Ds(ii)): CKs = "New"
                                    For i2 = 1 To ’ŒHp_Y_Typei:  If BB = ’ŒHp_Y_B(i2) Then CKs = "": Exit For
                                         Next i2
                                         If CKs = "New" Then ’ŒHp_Y_Typei = ’ŒHp_Y_Typei + 1: ’ŒHp_Y_B(’ŒHp_Y_Typei) = BB
                                ...
                                ’ŒHp_Y_Joint_Li = FP_‹´‹r_“S‹Ø_Data("KHL", "SD390", "‘Ñ‹Ø", "D" + f0(’ŒHp_Y_Œai)) ' ** **
                                For ii = 1 To ’ŒHp_Y_Typei
                                    Wda = "D" + f0(’ŒHp_Y_Œai)
                                    Wda = Wda + "_B" + F9(’ŒHp_Y_B(ii) + pkuitaiDai(1) + ’ŒHp_Y_Œai)
                                  '  Wda = Wda + "_D" + F9(’ŒHp_Y_D)
                                    Wda = Wda + "_D" + F9(’ŒHp_Y_D / 2 + ’ŒHp_Y_Joint_Li / 2) + "+J" + F9(’ŒHp_Y_Joint_Li) + "+" + F9(’ŒHp_Y_D / 2 - ’ŒHp_Y_Joint_Li / 2)
                                    Lm = Lm + 1: ’ŒData(Lm) = "“àHp_Y_•”•i=" + Wda + "_SD390"
                                    Next ii
                          
                          '[[[ Y•ûŒü “à‘¤Ì°Ìß Xpit ]]]
                                Wda = F_ŒvZ_•ª‰ğ(’ŒHp_Y_Pit_1s):    Call Ddata_D("+", Wda, Di, ni)
                                Wda = ""
                                For ii = 2 To ni Step 2:  TYi = 1: Piti = Di(ii - 2) / 2 + Di(ii - 1) + Di(ii) / 2
                                ...
                                Wda = F_ŒvZ_•ª‰ğ(’ŒHp_Y_Pit_2s):    Call Ddata_D("+", Wda, Di, ni)
                                Wda = ""
                                For ii = 2 To ni Step 2:  TYi = 1: Piti = Di(ii - 2) / 2 + Di(ii - 1) + Di(ii) / 2
                                    For i2 = 1 To ’ŒHp_Y_Typei:  If Di(ii) = ’ŒHp_Y_B(i2) Then TYi = i2: Exit For
                                        Next i2
...
'  ’·£‚ªƒRƒs[ '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
     ' ’Œ‘g—§‹Ø Begin
                          '[[[ ‘g—§‹Ø ]]]
                               Lm = Lm + 1: ’ŒData(Lm) = "'[[[ ‘g—§‹Ø ]]]"
           
                               Dim ‘g—§‹Ø_Œai As Single, ‘g—§‹Ø_L As Single, ‘g—§‹Ø_dti As Single, ‘g—§‹Ø_Pits As String
                               Dim ‘g—§‹Ø_Œas As String, ‘g—§‹Ø_Ls As String
           
                              '[[[ ‘g—§‹Ø Œai ]]]
                                ‘g—§‹Ø_Œai = pkuitaiDai(2)
                                ‘g—§‹Ø_Œas = "D" + F9(‘g—§‹Ø_Œai)
           
                              '[[[ ‘g—§‹Ø Xs ]]]
                                ‘g—§‹Ø_Ls = "_L" + F9(’Œ_BX - (Val(pKutai0(0)) + Val(pKutai9(1, 2))) * 2)
           
                              '[[[ ‘g—§‹Ø Pit ]]]
                                ‘g—§‹Ø_Pits = "_@" + Replace®s(pkuitaikumitate(1))
           
                  If InStr(‘g—§‹Ø_Pits, "(") > 0 Then ¢er = "System ’Œ ‘g—§‹Ø [" + pkuitaikumitate(1) + "]  ( ‚ª‚ ‚é": er (""): If ¢ŒëCK > 99 Then Stop
           
                   '* ‘g—§‹Ø_Pits = "_@1800+2x2100"    'Err ˆ—
           
                  If ‘g—§‹Ø_Œai > 1 Then Lm = Lm + 1: ’ŒData(Lm) = "‘g—§‹Ø=" + ‘g—§‹Ø_Œas + ‘g—§‹Ø_Ls + ‘g—§‹Ø_Pits + "_SD390"
...
'„¤„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„Ÿ„£
        ...
        Lm = 0
                       ...
                       Lm = Lm + 1: StoperData(Lm) = "' Cut  : “S‹Ø‚Ì¶¯Ä    N @“S‹Ø‚Ì¶¯Ä‚È‚µ "
        ...
        Stoperi = 1
              ...
              StoperYˆÊ’us = "_Z-150"   ' —Àã‚©‚ç‚ÌZL
              Stoper_Pits = pStopPictW1(3)
                  If Stoper_Pits = "" Then ¢er = " pStopPictW1(3)=''    ": er (""): If ¢ŒëCK > 99 Then Stop: Exit Sub Else Exit Sub
                  Stoper_Pits = FP_Stoper_H3ê—p(Stoper_Pits): If ¢er <> "" Then If ¢ŒëCK > 99 Then Stop: Exit Sub Else Exit Sub
    ...
    ' Lm = Lm + 1: —ÀData(Lm) = "errck'"
        ...
        Lm = Lm + 1: —ÀData(Lm) = ".—À" 'Œ…À
         ...
         '[[[ ŒBÀˆÊ’u ]]]
                 ...
                 Lm = Lm + 1: —ÀData(Lm) = "'  * ŒBÀˆÊ’u ‚Í I“_ ¶¨‰E   ‹N“_ ¶¨‰E ‚Ì‡”Ô‚É“ü—Í‚·‚é"
                 Lm = Lm + 1: —ÀData(Lm) = "ŒBÀˆÊ’u"
                         '  [[[ ŒBÀˆÊ’u ‚Í ‰º‹L‚Ì‡”Ô‚É“ü—Í‚·‚é ]]]
                         '  I“_ ¶¨‰E   ‹N“_ ¶¨‰E ‚Ì‡”Ô
                         '   -2650,320   0,320    2650,320
                         '   -1300,-575,½Ä¯Êß2    1300,-575,½Ä¯Êß2      ' X,Y,½Ä¯Êß°•„†
         ...
         '[[[ Loop ‚Í Ù°Ìß‹Ø ‚Å‚·  ]]]
                         ...
                         ‹N“_‘¤Loop‹Øri(1) = ƒ‹[ƒv“S‹ØR(1): ‹N“_‘¤Loop‹Øri(2) = ƒ‹[ƒv“S‹ØR(2)
          ...
          '[[[ Ù°Ìß‹Ø ‹N“_‘¤ ]]]
                  '[ ŠO Loop ]
                        ...
                        ' Loop‹ØBs = "_B" + F9(0.3 * Loop‹ØBi) + "+W+" + F9(0.7 * Loop‹ØBi)
                         Loop‹ØBi = (Loop‹ØBi - 1000) / 2
                         Loop‹ØBs = "_B" + F9(Loop‹ØBi) + "+W+" + F9(1000 + Loop‹ØBi)
                  ...
                  '[ “à Loop ]
                         Loop‹ØD· = Abs(pHariLoop(1, 2) - pHariLoop(1, 3))
                         Loop‹Ø‰¡dti = pHariLoop(1, 1) + Loop‹ØD· / 2
                         Loop‹Ø‰¡dts = "_K" + F9(Loop‹Ø‰¡dti)
                         Loop‹ØBi = pHariƒ‹[ƒv’¼ü’·(1) 'Loop‹ØBi '- Loop‹ØD·
                        ' Loop‹ØBs = "_B" + F9(0.3 * Loop‹ØBi) + "+W+" + F9(0.7 * Loop‹ØBi)
                         Loop‹ØBi = (Loop‹ØBi - 1000) / 2
                         Loop‹ØBs = "_B" + F9(1000 + Loop‹ØBi) + "+W+" + F9(Loop‹ØBi)
         ...
         '[[[ Ù°Ìß‹Ø I“_‘¤ ]]]
                  '[ ŠO Loop ]
                         ...
                         If Loop‹Ø•i > 0 Then
                               ...
                               End If
                  '[ “à Loop ]
                         Loop‹ØD· = Abs(pHariLoop(1, 5) - pHariLoop(1, 6))
                         Loop‹Ø‰¡dti = pHariLoop(1, 4) + Loop‹ØD· / 2
                         Loop‹Ø‰¡dts = "_K" + F9(Loop‹Ø‰¡dti)
                         Loop‹ØBi = pHariƒ‹[ƒv’¼ü’·(2) 'Loop‹ØBi '- Loop‹ØD·
                         Loop‹ØBi = (Loop‹ØBi - 1000) / 2
                         Loop‹ØBs = "_B" + F9(1000 + Loop‹ØBi) + "+W+" + F9(Loop‹ØBi)
        ...
        '[[[  ’¼‹Ø Ù°ÌßŠO’¼‹Ø    ]]]    ½Ä¯Êß•”•ª‚Í ¶¯Ä‚µ‚Ü‚·
                    '     Dim ‹N“_’¼‹Øpiti As Single, I“_’¼‹Øpiti As Single, ’¼‹ØStarti As Single, ’¼‹ØŠÔŠui As Single
                         ...
                         Lm = Lm + 1: —ÀData(Lm) = "'     ¦ LoopŠO’¼‹Ø’[•”, LoopŠO’¼‹Ø“à•” ‚ÍŒvZ‚µ‚Ü‚·"
        ...
        '[[[  ’¼‹Ø  Ù°Ìß“à’¼‹Ø   B2‚Å‚·  ]]]    ½Ä¯Êß•”•ª‚Í ¶¯Ä‚µ‚Ü‚·
                         ...
                         Lm = Lm + 1: —ÀData(Lm) = "'     ¦ Loop“à’¼‹Ø’[•”, Loop“à’¼‹Ø“à•” ‚ÍŒvZ‚µ‚Ü‚·"
        ...
        '[[[  ‰º’[‹Ø(‚ ‚²•”•ª) ‚Å‚·  ]]]   X² ‘ÎÛl—¶
                         ...
                         Lm = Lm + 1: —ÀData(Lm) = "' Z    : —Àã’[–Ê‚©‚ç‚Ì ZˆÊ’u‚Å‚·"
                      ...
                      'Lm = Lm + 1: —ÀData(Lm) = "'exp   ‰º’[‹Ø=D25_@136+164+4x250+400+4x250+164_B95+3445.1_D98+1337.68+1378.04_r150_SD390"
                        ...
                        Dim —À‰ºê‹ØŒas As String, —À‰ºê‹Ødts As String, —À‰ºê‹ØBs As String, —À‰ºê‹ØHs As String, —À‰ºê‹ØPits As String, —Àãê‹Ørs As String
                        Dim —À‰ºê‹ØZs As String
                        Dim —À‰ºê‹ØŒai As Single
                        ...
                        —À‰ºê‹ØŒai = pHariDai(4): If pHariDai(4) = 0 Then —À‰ºê‹ØŒai = 16: ¢er = " pHariDai(4)=0    ": er (""): ¢er = "": If ¢ŒëCK > 99 Then Stop

                        —À‰ºê‹ØŒas = "D" + f0(—À‰ºê‹ØŒai)
                        —À‰ºê‹Ødts = "_K" + F9(K1)
                        —À‰ºê‹ØZs = "_Z-" + F9(h1)
                        —À‰ºê‹ØBs = "_B" + F9(L2)
                        —À‰ºê‹ØHs = "_H" + F9(h3)
                        ...
                        '—Àãê‹Ørs = "_r=0"
                        Lm = Lm + 1: —ÀData(Lm) = "‰º’[‹Ø=" + —À‰ºê‹ØŒas + —À‰ºê‹Ødts + —À‰ºê‹ØZs + —À‰ºê‹ØBs + —À‰ºê‹ØHs + —À‰ºê‹ØPits + "_SD390"
        ...
        '[[[ …•½•â‹­‹Ø ‚Í —À ‘¤“S‹Ø ‚Å‚·  (…•½•â‹­‹Ø) ]]]
                         ...
                         Lm = Lm + 1: —ÀData(Lm) = "' D    : “S‹Ø‚ÌY•ûŒü’·‚³‚Å‚· –³‚¢ê‡©“®ŒvZ"
                         Lm = Lm + 1: —ÀData(Lm) = "' r    : ”¼Œa‚Å‚·"
                        ...
                        ' Lm = Lm + 1: —ÀData(Lm) = "'exp    …•½•â‹­‹Ø2=D25_B2850`1830_D2829_r270_SD390        ' **`** ‚Ìê‡‚Í À’·(r=__ ‚Í‰Á‚¦‚È‚¢)"
...
'                         Lm = Lm + 1: —ÀData(Lm) = "…•½•â‹­‹Ø2=" + …•½•â‹­‹ØŒas + …•½•â‹­‹Ødts + …•½•â‹­‹ØBs + …•½•â‹­‹ØDs + …•½•â‹­‹ØPits + "_SD390"
        ...
        '[[[  ’Œ“à •~‹Ø ‚Å‚·  ]]]      ½Ä¯Êß•”•ª‚Í ¶¯Ä‚µ‚Ü‚·
                         ...
                         Lm = Lm + 1: —ÀData(Lm) = "' K    : —Àãê‚©‚ç‚ÌˆÊ’u(ZÀ•W)‚Å‚·"
        ...
        '[[[  —À ½À°×¯Ìß ‚Å‚·  ]]]      ½Ä¯Êß•”•ª‚Í ¶¯Ä‚µ‚Ü‚·               2132~1335
                         ...
                         Lm = Lm + 1: —ÀData(Lm) = "' K    : —Àãê,—À‰ºê‚©‚ç‚Ì dt‚Å‚·"
                         'Lm = Lm + 1: —ÀData(Lm) = "' Y    : —À‰¡–Ê‚©‚ç‚ÌˆÊ’u‚Å‚·"
                         Lm = Lm + 1: —ÀData(Lm) = "' B    : ½À°×¯Ìß“S‹Ø‚Ì’·‚³‚Å‚· –³‚¢ê‡©“®ŒvZ"
                   ...
                   '[[[ ‰º½À°×¯Ìß ]]]
                        ...
                        '—ÀSt“S‹ØBs
                            ...
                            —ÀSt“S‹ØBi = —À_BY - Di(1) - Di(ni) + —À‰ºê‹ØŒai + —ÀSt“S‹ØYi
                  ...
                  '[[[ ‹N“_‘¤ã½À°×¯Ìß ]]]
                        ...
                        '—ÀSt“S‹ØHs
                            D0 = pHariStrD(1): D1 = Loop‹ØŒai: D2 = —À‰ºê‹ØŒai
...
'
    ...
    If }_‹´‹r_‡”Ôi(5) > 0 Then
        Wda = "    /DXF  Y    " + }_‹´‹r_•\¦–¼Ìs(5) + "   —tƒm“à       1/" + f0(}_‹´‹r_Scale(5))
        Lm = Lm + 1: }İ’èData(Lm) = Wda
        Lm = Lm + 1: }İ’èData(Lm) = "            }Œ`€–Ú=Y"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=100,450              .”z‹Ø}"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=100,380              .K1"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=100,+-30             .K2"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=100,+-30             .K3"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=100,+-30             .K4"
        Lm = Lm + 1: }İ’èData(Lm) = ""
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=100,250              .’f–Ê1"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0              .’f–Ê2"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0              .’f–Ê3"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0              .’f–Ê4"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0              .’f–Ê5"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0              .’f–Ê6"
        
        
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,250             .’f–Êb-b"
        
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=100,150   S=1/20     .”z‹Ø}1"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0   S=1/20     .”z‹Ø}2"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0   S=1/20     .”z‹Ø}3"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0   S=1/20     .”z‹Ø}4"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0   S=1/20     .”z‹Ø}5"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0   S=1/20     .”z‹Ø}6"
        
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0   S=1/20     .’f–Êb-b”z‹Ø}"
        Lm = Lm + 1: }İ’èData(Lm) = ""
        
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=100,70               .Hoop1"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0              .Hoop2"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0              .Hoop3"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0              .Hoop4"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0              .Hoop5"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0              .Hoop6"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+100,+0              .‘g—§‹Ø"
        
        Lm = Lm + 1: }İ’èData(Lm) = ""
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=550,80                .Hp’ê"
        Lm = Lm + 1: }İ’èData(Lm) = ""
    ...
    If }_‹´‹r_‡”Ôi(4) > 0 Then
     '  Lm = Lm + 1: }İ’èData(Lm) = "    /DXF   Šî‘b”z‹Ø}.DXF     Šî‘b”z‹Ø}   —tƒm“à       1/50"
        Wda = "    /DXF  Šî‘b    " + }_‹´‹r_•\¦–¼Ìs(4) + "   —tƒm“à       1/" + f0(}_‹´‹r_Scale(4))
        Lm = Lm + 1: }İ’èData(Lm) = Wda
        ...
        Lm = Lm + 1: }İ’èData(Lm) = ""
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=470,200             .FY2"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=470,150             .FY1"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=470,110             .FY3"
        Lm = Lm + 1: }İ’èData(Lm) = ""
        Lm = Lm + 1: }İ’èData(Lm) = ""
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=640,210             .Stü˜H•ûŒü"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+0,+-80             .St’¼Šp•ûŒü"
        Lm = Lm + 1: }İ’èData(Lm) = ""
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=600,390             .FX2"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=680,390             .FX3"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=750,390             .FX1"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=780,390             .FX4"
        Lm = Lm + 1: }İ’èData(Lm) = ""
        Lm = Lm + 1: }İ’èData(Lm) = ""
        End If
    ...
    If }_‹´‹r_‡”Ôi(2) > 0 Then
        ...
        Wda = "    /DXF  x³    " + }_‹´‹r_•\¦–¼Ìs(2) + "   —tƒm“à       1/" + f0(}_‹´‹r_Scale(2))
        Lm = Lm + 1: }İ’èData(Lm) = Wda
        Lm = Lm + 1: }İ’èData(Lm) = "            }Œ`€–Ú=x³"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=200,440             .ŒBÀ•½–Ê"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=200,260             .Stoper•½–Ê"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=410,450             .ŒBÀ’f–Ê"
    ...
    If }_‹´‹r_‡”Ôi(3) > 0 Then
        ...
        Wda = "    /DXF  ‹ë‘Ì    " + }_‹´‹r_•\¦–¼Ìs(3) + "   —tƒm“à       1/" + f0(}_‹´‹r_Scale(3))
        Lm = Lm + 1: }İ’èData(Lm) = Wda
        Lm = Lm + 1: }İ’èData(Lm) = "            }Œ`€–Ú=‹ë‘Ì"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=200,175             .—§’f–ÊX"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=200,70              .•½’f–Ê"
     '   Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=200,-120            .’Œ“ª•½’f–Ê"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=460,175             .—§’f–ÊY"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=380,70  S=1/30    .•½’f–Ê“S‹Ø”z‹Ø}" ''''' nagase -120
        Lm = Lm + 1: }İ’èData(Lm) = ""
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=620,175             .C1"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+30,175             .C2"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+30,175             .C3"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+30,175             .C4"
     ...
     ' ’Œ‘g—§‹Ø Begin
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=580,150             .‘g—§‹Ø"
     ' ’Œ‘g—§‹Ø End
        
'  ƒXƒ^[ƒ‰ƒbƒv
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=580,120             .ŠOHpX" 'Œ´“_=420,130
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=515,80              .ŠOHpY" 'Œ´“_=335,80
                
        Lm = Lm + 1: }İ’èData(Lm) = ""
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=580,80              .“àHpX1" 'Œ´“_=420,80
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=580,+-40            .“àHpX2" '''''' +-‚Íadd nagase
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=580,+-40            .“àHpX3"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=580,+-40            .“àHpX4"
        Lm = Lm + 1: }İ’èData(Lm) = ""
        
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=660,80              .“àHpY1"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+50,+0              .“àHpY2"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+50,+0              .“àHpY3"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+50,+0              .“àHpY4"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+50,+0              .“àHpY5"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+50,+0              .“àHpY6"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+50,+0              .“àHpY7"
        Lm = Lm + 1: }İ’èData(Lm) = ""
        Lm = Lm + 1: }İ’èData(Lm) = ""
        Lm = Lm + 1: }İ’èData(Lm) = ""
        End If
    ...
    If }_‹´‹r_‡”Ôi(1) > 0 Then
        ...
        Wda = "    /DXF  —À   " + }_‹´‹r_•\¦–¼Ìs(1) + "   —tƒm“à       1/" + f0(}_‹´‹r_Scale(1))
        Lm = Lm + 1: }İ’èData(Lm) = Wda
        Lm = Lm + 1: }İ’èData(Lm) = "            }Œ`€–Ú=—À"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=200,480             .—§’·’f–Ê"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=200,315             .•½’f–Ê"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=200,-120            .’f–ÊC-C"  ' ˜gŠO
        
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=450,480             .—§’Z’f–Êa"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+180,+0             .—§’Z’f–Êb" ' ‰E‘¤  Stoper
        'Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+180,+0             .—§’Z’f–Êc" ' ¶‘¤  Stoper
        'Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+180,+0             .—§’Z’f–Êd" ' —¼‘¤@Stoper
       ...
       ' Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=670,-120  S=1/20     .’f–Ê“S‹Ø”z‹Ø}"    ' ˜gŠO
        ...
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=400,340             .‰º’[‹Ø"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+120,+0             .…•½•â‹­‹Ø"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+120,+0             .…•½•â‹­‹Ø2"
        
        
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=300,260             .*"  ' ÀŞĞ°
        If —À_LoopŠO’¼‹Øi > 0 Then
            
            Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+70,+0             .‹N“_‘¤LoopŠO’¼‹Ø’[•”"
            Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+70,+0              .‹N“_‘¤LoopŠO’¼‹Ø“à•”2"
            Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+70,+0              .‹N“_‘¤LoopŠO’¼‹Ø“à•”3"
            
            Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+70,+0              .I“_‘¤LoopŠO’¼‹Ø’[•”"
            Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+70,+0              .I“_‘¤LoopŠO’¼‹Ø“à•”2"
            Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+70,+0              .I“_‘¤LoopŠO’¼‹Ø“à•”3"
        
            End If
        
        If —À_Loop“à’¼‹Øi > 0 Then
        
            Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+70,+0             .‹N“_‘¤Loop“à’¼‹Ø’[•”"
            Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+70,+0             .‹N“_‘¤Loop“à’¼‹Ø“à•”2"
            Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+70,+0             .‹N“_‘¤Loop“à’¼‹Ø“à•”3"
            
            Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+70,+0              .I“_‘¤Loop“à’¼‹Ø’[•”"
            Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+70,+0              .I“_‘¤Loop“à’¼‹Ø“à•”2"
            Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+70,+0              .I“_‘¤Loop“à’¼‹Ø“à•”3"
        
            End If
        
        
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=380,210             .•~‹Ø1"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+60,+0              .•~‹Ø2"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+60,+0              .•~‹Ø3"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+60,+0              .•~‹Ø4"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+60,+0              .•~‹Ø5"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+60,+0              .•~‹Ø6"
        
        
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=370,160             .ãSt1"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+60,+0              .ãSt2"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+60,+0              .ãSt3"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+60,+0              .ãSt4"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+60,+0              .ãSt5"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=+60,+0              .ãSt6"
        
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=370,80              .‰ºSt"
        Lm = Lm + 1: }İ’èData(Lm) = ""
        Lm = Lm + 1: }İ’èData(Lm) = ""
    ...
    If }_‹´‹r_‡”Ôi(6) > 0 Then
        Wda = "    /DXF  Ş—¿•\   " + }_‹´‹r_•\¦–¼Ìs(6) + "   —tƒm“à       1/" + f0(}_‹´‹r_Scale(6))
        Lm = Lm + 1: }İ’èData(Lm) = Wda
        Lm = Lm + 1: }İ’èData(Lm) = "            }Œ`€–Ú=Ş—¿•\"
        Lm = Lm + 1: }İ’èData(Lm) = "            Œ´“_=370,80    .•\ì¬"
...
Function FP_Stoper_H3ê—p(ByVal Moj As String)
      ' FP_Stoper_H3ê—p
...
Public Function F_ŒvZ_•ª‰ğ(ByVal Moj As String)
   '  ŒvZ®‚ğ‚·‚×‚Ä ___+___+___ ‚É‚µ‚Ü‚·
    ' x ‚Í@( ) ‚Ì‘O‚É•t‚¯‚é
...
Private Function FPŒvZX(ByVal Moj As String) As Double
    '  8x150 ‚ğŒvZ‚·‚é   1200
...
Sub SP_’Œ_å‹Ø_H(ByVal “S‹ØŞís As String, ByVal å‹ØŒas As String, ByRef StartˆÊ’ui As Single, ByRef h0 As Single, ByRef h2_0 As Single)
    ' ’Œ_å‹Ø‚Ì H ‚ğŒvZ
    ' h0       1’i–Úå‹ØL
    ' h2_0     2’i–Úå‹ØL
    ...
    Dim h2_1 As Single, h2_8 As Single
        ...
        h4 = å‹ØŒai / 2 + FP_‹´‹r_“S‹Ø_Data("r1", “S‹ØŞís, "•W€", å‹ØŒas)
        h5 = h2 - (h3 + h4)
